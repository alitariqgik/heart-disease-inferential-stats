...
# Variable	Name	            Type	          Description
  ...
  X2	      Sex	            Categorical 	 0 = Female, 1 = Male
  X3	      cp 	            Categorical	1–4 pain categories
  X4	      chol  	         Numerical	    Serum cholesterol in mg/dl
  X5	      thalach 	         Numerical	    Max HR achieved during exercise
  X6	      exang 	         Categorical  	 0 = No, 1 = Yes
  X7	      oldpeak        	Numerical	    ECG ST segment depression
  X8	      ca 	        Numerical/Categorical	Number of major vessels (0–3) 
  Y	      target_binary	  Binary	          0 = No disease, 1 = Disease

# Project Deliverables

# 1. Conceptual Modeling (Conceptual_Modeling.docx)
2. Formal variable definitions with probabilistic types
...
# 6. Implementation Notebook (INFERENTIAL_PROJECT.ipynb)
